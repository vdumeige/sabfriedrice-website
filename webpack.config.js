...
module.exports = {
  ...
  plugins: [
    ...
    new HandlebarsPlugin({
      ...
      // ✅ Load `menu.json` as `menu` so Handlebars can use it
      data: {
      ...
      helpers: {
        ...
        // ✅ Add `eq` helper for category filtering in `menu.html`
        eq: function (v1, v2) {
          return v1 === v2;
        },
      },
  ...
  devServer: {
    static: {
        directory: path.join(__dirname, 'src/img'), // Serve images from src/img
        publicPath: '/img', // Access images at /img/
    },
